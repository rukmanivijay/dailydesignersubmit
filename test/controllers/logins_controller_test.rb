...
class LoginsControllerTest < ActionController::TestCase
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post :create, login: { city: @login.city, password: @login.password, sex: @login.sex, state: @login.state, username: @login.username }
    end
  ...
  test "should update login" do
    patch :update, id: @login, login: { city: @login.city, password: @login.password, sex: @login.sex, state: @login.state, username: @login.username }
    assert_redirected_to login_path(assigns(:login))
  end
